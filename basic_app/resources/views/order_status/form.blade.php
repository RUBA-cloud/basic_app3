...
<form method="POST" action="{{ $action }}" id="order-status-form" enctype="multipart/form-data">
    @csrf
    ...
    <x-form.textarea
        ...
        :value="old('name_en', $orderStatus?->name_en ?? '')"
    />
 ...
 <x-form.textarea
        ...
        :value="old('name_ar', $orderStatus?->name_ar ?? '')"
    />
    ...
    {{-- Is Active --}}
    @php
        $isActive = (int) old('is_active', (int) ($orderStatus?->is_active ?? 1));
    @endphp
