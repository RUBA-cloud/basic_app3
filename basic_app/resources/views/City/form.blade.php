...
<form id="city-form"
    ...
    {{-- ✅ Country Select --}}
    @php
        $selectedCountryId = old('country_id', data_get($cityObject, 'country_id', ''));
    @endphp
    ...
    <div class="form-group" style="margin: 20px 0;">
        ...
        @php $isActive = (int) old('is_active', (int) data_get($cityObject,'is_active', 1)); @endphp
