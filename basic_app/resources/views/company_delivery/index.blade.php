...
<div style="min-height: 100vh; display: flex; flex-direction: row; align-items: stretch;">
    ...
    <main style="flex: 1; padding: 40px 32px;">
        <div class="card-table" style="padding: 24px">
            {{-- Action Buttons --}}
            <x-action_buttons
            label="{{__('adminlte::adminlte.company_delivery')}}"
                addRoute="company_delivery.create"
                historyRoute="company_delivery.history"
                :showAdd="true"
            />
    ...
    <livewire:adminlte.data-table
        ...
        model="\App\Models\CompanyDelivery"       {{-- any Eloquent model --}}
        ...
        reactive-route="company_delivery.restore"
