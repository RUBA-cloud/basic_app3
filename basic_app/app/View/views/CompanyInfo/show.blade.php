...
@php
    $labels = [
        ...
        'address_en' => __('adminlte::adminlte.address_en'),
        'address_ar' => __('adminlte::adminlte.address_ar'),
...
<div class="container-fluid py-4" dir="{{ $isRtl ? 'rtl' : 'ltr' }}">
    ...
    <x-adminlte-card title="{{ __('adminlte::adminlte.company_info') }}" theme="primary" icon="fas fa-building" collapsible>
        ...
        <div class="row">
            {{-- Left Column --}}
            <div class="col-md-6">
                <x-adminlte-card title="{{ __('adminlte::adminlte.basic_info') }}" theme="lightblue" icon="fas fa-info-circle" collapsible>
                    <dl class="row">
