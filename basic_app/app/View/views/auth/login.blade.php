    ...
    <div style="flex:1.2; background:#ffff; border-radius: 0 24px 24px 0; display:flex; flex-direction:column; justify-content:center; align-items:center; min-width:320px; box-shadow: 0 8px 32px 0 rgba(31,38,135,0.12);">
        <div style="width:50%; max-width:420px; margin:0 auto; padding:48px 32px;">
            ...
            <div style="display:flex; justify-content:flex-end; margin-bottom:18px;">
                ...
                <a href="{{ route('register') }}" style="color:#6C63FF; font-weight:600; border:1px solid #eee; border-radius:8px; padding:4px 18px; background:#fff; text-decoration:none;">SIGN IN</a>
            </div>

            <div style="text-align:left; margin-bottom:32px;">
                <h2 style="font-size:2rem; font-weight:700; color:#22223B; margin-bottom:8px;">{{ __('adminlte::adminlte.login_title') }}</h2>
                <p style="color:#888; font-size:1rem; margin-bottom:0;">{{ __('adminlte::adminlte.login_title') }}</p>
            </div>
